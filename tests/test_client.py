...
from toweroffantasy import Toweroffantasy, AsyncToweroffantasy, APIResponseValidationError
from toweroffantasy._types import Omit
from toweroffantasy._utils import asyncify
from toweroffantasy._models import BaseModel, FinalRequestOptions
from toweroffantasy._exceptions import APIStatusError, APITimeoutError, ToweroffantasyError, APIResponseValidationError
from toweroffantasy._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Toweroffantasy | AsyncToweroffantasy) -> int:
...
class TestToweroffantasy:
    client = Toweroffantasy(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "toweroffantasy/_legacy_response.py",
                        "toweroffantasy/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "toweroffantasy/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(ToweroffantasyError):
            with update_env(**{"TOWEROFFANTASY_BEARER_TOKEN": Omit()}):
                client2 = Toweroffantasy(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Toweroffantasy) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TOWEROFFANTASY_BASE_URL="http://localhost:5000/from/env"):
            client = Toweroffantasy(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Toweroffantasy) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Toweroffantasy) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Toweroffantasy) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Toweroffantasy(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Toweroffantasy(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("toweroffantasy._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Toweroffantasy) -> None:
        respx_mock.post("/auth/login").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.auth.with_streaming_response.login(email="email", password="password").__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("toweroffantasy._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Toweroffantasy) -> None:
    ...
    def test_retries_taken(
        ...
        response = client.auth.with_raw_response.login(email="email", password="password")
    ...
    def test_omit_retry_count_header(
        self, client: Toweroffantasy, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.auth.with_raw_response.login(
            email="email", password="password", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.auth.with_raw_response.login(
            email="email", password="password", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncToweroffantasy:
    client = AsyncToweroffantasy(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(ToweroffantasyError):
            with update_env(**{"TOWEROFFANTASY_BEARER_TOKEN": Omit()}):
                client2 = AsyncToweroffantasy(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncToweroffantasy) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TOWEROFFANTASY_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncToweroffantasy(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncToweroffantasy) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncToweroffantasy) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncToweroffantasy) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncToweroffantasy(
        ...
        client = AsyncToweroffantasy(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncToweroffantasy
    ) -> None:
        respx_mock.post("/auth/login").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.auth.with_streaming_response.login(email="email", password="password").__aenter__()
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncToweroffantasy,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.auth.with_raw_response.login(email="email", password="password")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncToweroffantasy, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
