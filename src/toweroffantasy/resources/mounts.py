...
class MountsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        exclude_mount_type: Optional[SequenceNotStr[str]] | Omit = omit,
        exclude_quality: Optional[SequenceNotStr[str]] | Omit = omit,
        include_ids: Optional[SequenceNotStr[str]] | Omit = omit,
        include_mount_type: Optional[SequenceNotStr[str]] | Omit = omit,
        include_quality: Optional[SequenceNotStr[str]] | Omit = omit,
        lang: LangsEnum | Omit = omit,
        limit: int | Omit = omit,
